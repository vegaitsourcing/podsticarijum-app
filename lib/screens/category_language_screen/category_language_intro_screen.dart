import 'package:app_for_family_backup/common/data/pages/language_development.dart';
...
class CategoryLanguageIntroScreen extends StatelessWidget {
  static const String route = '/category_language_details_intro';
  ...
  CategoryLanguageIntroScreen({Key? key}) : super(key: key);
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      LanguageDevelopment.paragraph1,
                      textAlign: TextAlign.start,
                      style: Theme.of(context).textTheme.bodyText1,
                    ),
                    Text(
                      LanguageDevelopment.paragraph2,
                      textAlign: TextAlign.start,
                      style: Theme.of(context).textTheme.bodyText1,
                    ),
                    Text(
                      LanguageDevelopment.paragraph3,
                      textAlign: TextAlign.start,
                      style: Theme.of(context).textTheme.bodyText1,
                    ),
                  ],
              ...
              Text(
                'Senzo-Languageni razvoj utiče na procese učenja',
