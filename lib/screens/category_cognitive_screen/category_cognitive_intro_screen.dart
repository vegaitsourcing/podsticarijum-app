...
class CategoryCognitiveIntroScreen extends StatelessWidget {
  static const String route = '/category_cognitive_details_intro';
  ...
  CategoryCognitiveIntroScreen({Key? key}) : super(key: key);
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                'Cognitive razvoj utiče na procese učenja',
