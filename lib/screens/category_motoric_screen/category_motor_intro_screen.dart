...
class CategoryMotorIntroScreen extends StatelessWidget {
  static const String route = '/category_motor_details_intro';
  ...
  CategoryMotorIntroScreen({Key? key}) : super(key: key);
